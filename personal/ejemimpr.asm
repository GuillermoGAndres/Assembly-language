...
inicio:				;etiqueta start
	...
	posicionaCursor 03h,00h ;posiciona cursor en renglon 3, columna 0
	;Imprime  caracteres. Contenido del  registro al
	mov al,'A'		;al = 'A' = 41h
	mov ah,09h		;opcion 9 para interrupcion 10h
				;mov bl,0Eh   ;bl = 0Eh , guarda los atributos del caracter
	mov bl,03h
	mov cx,5		;cx = 1, se imprimira CX veces el caracter contenido en AL
	int 10h			;interrupcion 10h. Imprime caracteres.
	...
	int 10h 		;interrupcion 10h. Imprime caracter.
